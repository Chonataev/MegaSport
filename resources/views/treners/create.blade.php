...
<div class="mt-10 sm:mt-0">
  <div class="md:grid md:grid-cols-3 md:gap-6">
    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
      <form action="{{route('treners.store')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-2">
                ...
                <input type="text" name="rank" id="email_address" autocomplete="email" class="py-2 px-3 mt-1 border mt-1 focus:ring-indigo-300 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
              </div>
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input type="text" name="contacts" id="text" autocomplete="contacts" class="py-2 px-3 mt-1 border mt-1 focus:ring-indigo-300 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">     
              </div>
