          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-4">
                ...
                <input type="text" name="title" id="title" autocomplete="title" value="{{$page->title}}" class=" py-2 px-3 mt-1 border border-gray-300 focus:ring-indigo-300 focus:border-indigo-300 block w-full sm:text-sm  rounded-md">
              </div>
