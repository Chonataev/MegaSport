        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <img src="{{$page->image}}" class="w-16 h-18" alt="">
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                {{$page->title}}
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-left flex justify-between mt-3 pr-10 font-medium">
                <a href="{{route('pages.show',$page->id)}}" class="text-blue-600 hover:text-blue-700">Show</a>                
                <a href="{{route('pages.edit',$page->id)}}" class="text-green-600 hover:text-green-700">Edit</a>
                <form action="{{route('pages.destroy',$page->id)}}" method="POST" onsubmit="return confirm('Вы уверены удалить запись?');">
